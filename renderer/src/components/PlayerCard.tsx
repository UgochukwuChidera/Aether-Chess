  ...
  return (
    ...
    >
      ...
      <div className="relative flex-shrink-0">
        <div
          className="w-9 h-9 rounded-full bg-surface2 flex items-center justify-center
      ...
      {timeSeconds !== undefined && (
        <div
          className={`px-2 py-1 rounded font-mono text-base font-semibold tabular-nums
                      transition-all
                      ${isActive && isUser
                        ? 'bg-accent text-bg glow-accent-sm'
                        : 'bg-surface2 text-on-surface'}`}
