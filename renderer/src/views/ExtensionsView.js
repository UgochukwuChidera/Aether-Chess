...
exports.ExtensionsView = void 0;
const react_1 = require("react");
const ExtensionsView = () => (<div className="flex flex-col items-center justify-center gap-3 py-16">
...
exports.ExtensionsView = ExtensionsView;
